...
namespace Creator.Utilities
{
    ...
    public static class D
    {
        ...
        private static string Message(string prefix, Object obj, params object[] message)
        {
            var objName = obj != null 
                ? $"<b>{obj.name.Color("lightblue")}</b>" 
                : String.Empty;
            var prefixes = !String.IsNullOrEmpty(prefix) && obj != null
                ? $"{prefix.Color("lightblue")}"
                : String.Empty;
        ...
        {
#if UNITY_EDITOR
            Debug.Log(Message("Info - ", null, message)); 
#endif
        }
        ...
        {
#if UNITY_EDITOR
            Debug.Log(Message("Info - ", context, message)); 
#endif
        }
        ...
        {
#if UNITY_EDITOR
            Debug.LogError(Message("Error - ", null, message)); 
#endif
        }
        ...
        {
#if UNITY_EDITOR
            Debug.LogError(Message("Error - ", context, message)); 
#endif
        }
        ...
        {
#if UNITY_EDITOR
            Debug.LogWarning(Message("Warn - ", null, message)); 
#endif
        }
        ...
        {
#if UNITY_EDITOR
            Debug.LogWarning(Message("Warn - ", context, message)); 
#endif
        }
