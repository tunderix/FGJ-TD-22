...
Shader "Unlit/sdr_ColoredLightNShadow01"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult155 = lerp( tex2D( _TextureSample1, uv_TextureSample1 ) , color153 , ase_lightAtten);
...
/*ASEBEGIN
Version=18934
-1920;0;1920;1059;325.1504;-614.8809;1.84646;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;152;1556.122,1647.191;Inherit;False;Property;_LightStrength;Light Strength;0;0;Create;True;0;0;0;False;0;False;1;0;0;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=590984F0E8C547B58FDA018DDC0DC28C579F5E60